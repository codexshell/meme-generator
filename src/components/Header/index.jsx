...
export function Header() {
  return (
    <header className="text-white h-[65px] max-w-[550px] flex items-center justify-between bg-gradient-to-r from-purple1 from-[1.18%] to-purple2 to-100% pl-5 pr-[37px]">
